    ...
    stages {
        ...
        stage('Deploy Frontend to Tomcat') {
            steps {
                ...
                xcopy /E /I /Y hotelmangementapi-react\\dist\\* "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\hotelmanagement"
                '''
            }
        }
        ...
        stage('Build Backend') {
            steps {
                dir('HOTELMANGEMENTAPI-SRPINGBOOT') {
        ...
        stage('Deploy Backend to Tomcat') {
            steps {
                ...
                copy "HOTELMANGEMENTAPI-SRPINGBOOT\\target\\*.war" "C:\\Program Files\\Apache Software Foundation\\Tomcat 10.1\\webapps\\"
                '''
            }
        }
